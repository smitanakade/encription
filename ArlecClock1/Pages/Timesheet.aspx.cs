...
namespace ArlecClock.Pages
{
    public partial class Timesheet : System.Web.UI.Page
    {
        ...
        public void GenerateTimesheetListView()
        {
            ...
            {
                foreach (ArlecClock.DAL.Employee temp in employeestemp)
                {
                    ArlecClock.DAL.EmpTimesheet newEmpTimesheet = new EmpTimesheet();
        ...
        public string GetEmpName(int empId)
        {
            ...
            var employee = (from e in context.Employees
                            where e.Id == empId
                            select e);
            ArlecClock.DAL.Employee emp = employee.First();
            return emp.FirstName + " " + emp.LastName;
            //ArlecClock.DAL.Employee
        }
